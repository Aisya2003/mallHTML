        ...
        <el-card class="box-card" style="width: 80%; margin: 20px auto">
          ...
          >
            ...
            <el-form-item label="选择分类" prop="catalogId">
              <category-cascader v-model="spu.catalogId"></category-cascader>
            </el-form-item>
...
export default {
  ...
  methods: {
    ...
    checkDefaultImg(row, index, img) {
      ...
      //这个图片被选中了，
      console.log("img",img)
      row.images[index].imgUrl = img[0]; //默认选中
      console.log("imgUrl",row.images[index].imgUrl )
    ...
    generateSaleAttrs() {
      ...
      console.log("catalogid",this.spu.catalogId)
      this.step = 2;
