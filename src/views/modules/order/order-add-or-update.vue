          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data) {
                ...
                this.dataForm.payAmount = data.data.payAmount
                this.dataForm.freightAmount = data.data.freightAmount
                ...
                this.dataForm.deliveryCompany = data.data.deliveryCompany
                this.dataForm.deliverySn = data.data.deliverySn
                this.dataForm.autoConfirmDay = data.data.autoConfirmDay
                this.dataForm.integration = data.data.integration
                this.dataForm.growth = data.data.growth
                this.dataForm.billType = data.data.billType
                this.dataForm.billHeader = data.data.billHeader
                this.dataForm.billContent = data.data.billContent
                this.dataForm.billReceiverPhone = data.data.billReceiverPhone
                this.dataForm.billReceiverEmail = data.data.billReceiverEmail
                this.dataForm.receiverName = data.data.receiverName
                this.dataForm.receiverPhone = data.data.receiverPhone
                this.dataForm.receiverPostCode = data.data.receiverPostCode
                this.dataForm.receiverProvince = data.data.receiverProvince
                this.dataForm.receiverCity = data.data.receiverCity
                this.dataForm.receiverRegion = data.data.receiverRegion
                this.dataForm.receiverDetailAddress = data.data.receiverDetailAddress
                this.dataForm.note = data.data.note
                this.dataForm.confirmStatus = data.data.confirmStatus
                this.dataForm.deleteStatus = data.data.deleteStatus
                this.dataForm.useIntegration = data.data.useIntegration
                this.dataForm.paymentTime = data.data.paymentTime
                this.dataForm.deliveryTime = data.data.deliveryTime
                this.dataForm.receiveTime = data.data.receiveTime
                this.dataForm.commentTime = data.data.commentTime
                this.dataForm.modifyTime = data.data.modifyTime
              }
            })
          }
        })
